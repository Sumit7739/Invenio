...
<body>
    ...
    <form id="calendar_container" method="post">
        ...
        <a href="test.php"><button type="button" id="search-btn">clear</button></a>
    </form>
    ...
    <!-- <script>
        ...
        searchBtn.addEventListener('click', function() {
            // Simulate form submission (replace this with your actual processing)
            inventoryTable.classList.remove('hidden'); // Show the table
            // Perform any additional actions after form submission (e.g., data fetching)
            searchBtn.click(); // Simulate a second click
        });
    </script> -->
