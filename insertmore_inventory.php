...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt_items = $conn->prepare("INSERT INTO moreinventory_item (date, py8, py9)
        VALUES (?, ?, ?)");
        ...
        $stmt_units = $conn->prepare("INSERT INTO moreinventory_unit (item_id,  payal8_unit, payal9_unit)
        VALUES (?, ?, ?)");
