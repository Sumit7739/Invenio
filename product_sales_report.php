...
<body>
    ...
    $sql_items = "SELECT id, bl5, bl6, bl7, bl9, sp5, sp6, sp7, sp9, wl5, wl6, wl7, wl9, ld8, ld9, ld11, dld, pp, cups50, cups60, cups80, cups100, cups150, cups210, cups250, bd5, bd6, bd7, cp5, cp6, cp7, cp9 FROM sales_item";
    ...
    if ($result_items->num_rows > 0) {
        ...
        echo "No rows found in Sales Item.";
    }
    ...
    if ($result_units->num_rows > 0) {
        ...
        echo "No rows found in Sales Unit.";
