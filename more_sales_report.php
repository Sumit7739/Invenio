...
$sqlInventoryPY = "SELECT py8, py9 FROM moresales_item";
...
<body>
    ...
    <div class="container">
        ...
        <div class="chart-container">
            ...
            <p class="chart-description">Insights: This chart shows the distribution of <strong> PY </strong> in the Sales.</p>
        </div>
    </div>
    <script>
