...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['date'])) {
        ...
        JOIN inventory_unit ON inventory_item.id = inventory_unit.item_id
        SET inventory_item.name = ?, inventory_item.date = ?,
            inventory_item.bl5 = ?, inventory_unit.bl5_unit = ?,
            inventory_item.bl6 = ?, inventory_unit.bl6_unit = ?,
            inventory_item.bl7 = ?, inventory_unit.bl7_unit = ?,
            inventory_item.bl9 = ?, inventory_unit.bl9_unit = ?,
            inventory_item.sp5 = ?, inventory_unit.sp5_unit = ?,
            inventory_item.sp6 = ?, inventory_unit.sp6_unit = ?,
            inventory_item.sp7 = ?, inventory_unit.sp7_unit = ?,
            inventory_item.sp9 = ?, inventory_unit.sp9_unit = ?,
            inventory_item.wl5 = ?, inventory_unit.wl5_unit = ?,
            inventory_item.wl6 = ?, inventory_unit.wl6_unit = ?,
            inventory_item.wl7 = ?, inventory_unit.wl7_unit = ?,
            inventory_item.wl9 = ?, inventory_unit.wl9_unit = ?,
            inventory_item.ld8 = ?, inventory_unit.ld8_unit = ?,
            inventory_item.ld9 = ?, inventory_unit.ld9_unit = ?,
            inventory_item.ld11 = ?, inventory_unit.ld11_unit = ?,
            inventory_item.dld = ?, inventory_unit.dld_unit = ?,
            inventory_item.pp = ?, inventory_unit.pp_unit = ?,
            inventory_item.cups50 = ?, inventory_unit.cups50_unit = ?,
            inventory_item.cups60 = ?, inventory_unit.cups60_unit = ?,
            inventory_item.cups80 = ?, inventory_unit.cups80_unit = ?,
            inventory_item.cups100 = ?, inventory_unit.cups100_unit = ?,
            inventory_item.cups150 = ?, inventory_unit.cups150_unit = ?,
            inventory_item.cups210 = ?, inventory_unit.cups210_unit = ?,
            inventory_item.cups250 = ?, inventory_unit.cups250_unit = ?,
            inventory_item.bd5 = ?, inventory_unit.bd5_unit = ?,
            inventory_item.bd6 = ?, inventory_unit.bd6_unit = ?,
            inventory_item.bd7 = ?, inventory_unit.bd7_unit = ?,
            inventory_item.cp5 = ?, inventory_unit.cp5_unit = ?,
            inventory_item.cp6 = ?, inventory_unit.cp6_unit = ?,
            inventory_item.cp7 = ?, inventory_unit.cp7_unit = ?,
            inventory_item.cp9 = ?, inventory_unit.cp9_unit = ?
