...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['start-date']) && isset($_POST['end-date'])) {
        ...
        $sql = "SELECT id, date, py8, py9 FROM moresales_item WHERE date BETWEEN ? AND ?";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql_units = "SELECT item_id, payal8_unit, payal9_unit FROM moresales_unit WHERE item_id IN (" . implode(',', array_keys($items)) . ")";
