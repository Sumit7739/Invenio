...
<body>
    <div class="content-row">
        <button type="button" class="toggle-btn"><a href="more_sales.php">CREATE NEW</a></button>
    ...
    <button type="button" class="clear-btn"><a href="view_moresales.php">Clear</a></button>
    ...
    <section id="dataSection">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='moresales_data.php?id=" . $row["id"] . "'>View</a>";
                echo "</div>";
